...
class Environment{
public:
    Environment(double stepSize, std::string folder, int set, double macRecRate, double cancerProl, int perturb, double perturbTime, double perturbLvl, int rep);
...
private:
    ...
    //optional replicate params for script 
    int rep_id; 
